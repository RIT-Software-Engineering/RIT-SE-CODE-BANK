...
-- App ID 7: Tyler Tester for SWEN-561-2 (Status: APPLIED)
('Tyler Tester', 'JobPositionApplicationHistory', '7', 'APPLIED', 'Initial application submitted by candidate.', '2025-08-01T13:00:00Z'),

-- App ID 8: Tyler Tester for 2237-SWEN-344-1 (Status: INACTIVE)
('Tyler Tester', 'JobPositionApplicationHistory', '8', 'APPLIED', 'Initial application submitted by candidate.', '2025-07-05T16:45:00Z'),
('Dr. John Doe', 'JobPositionApplicationHistory', '8', 'INTERVIEW', 'Candidate has prior experience and a great academic record. Scheduling an interview.', '2025-07-06T09:00:00Z'),
('Dr. John Doe', 'JobPositionApplicationHistory', '8', 'PENDING_OFFER', 'Interview went exceptionally well. Very knowledgeable and articulate. Extending an offer.', '2025-07-07T10:00:00Z'),
('Tyler Tester', 'JobPositionApplicationHistory', '8', 'ACCEPTED_OFFER', 'Candidate has accepted the offer for the position.', '2025-07-08T11:00:00Z'),
('Alice Admin', 'JobPositionApplicationHistory', '8', 'HIRED', 'Candidate has accepted the offer for the position.', '2025-07-09T12:00:00Z'),
('Alice Admin', 'JobPositionApplicationHistory', '8', 'INACTIVE', 'Position for this course and semester is no longer available. Application moved to inactive.', '2025-07-10T11:00:00Z'),

-- App ID 9: Sally Student for SWEN-344-1 (Status: REJECTED)
('Sally Student', 'JobPositionApplicationHistory', '9', 'APPLIED', 'Initial application submitted by candidate.', '2025-07-20T12:00:00Z'),
('Dr. John Doe', 'JobPositionApplicationHistory', '9', 'REJECTED', 'While the candidate has a good grade, we have decided to move forward with other applicants who have more relevant prior TA experience.', '2025-07-21T13:45:00Z'),

-- App ID 10: Sally Student for SWEN-261-1 (Status: APPLIED)
('Sally Student', 'JobPositionApplicationHistory', '10', 'APPLIED', 'Initial application submitted by candidate.', '2025-08-05T09:30:00Z');