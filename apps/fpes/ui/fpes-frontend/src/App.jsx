...
function App() {
  ...
  const pages = [
    ...
    },
    {
      ...
      route : "/annual-eval",
      roles_with_access : new Set(["Faculty", "Admin"])
    },
    {
    ...
    <ThemeProvider theme={theme}>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/annual-eval" element={<ProtectedRoute isAuthenticated={isAuthenticated}> <AnnualEvalPage facultyId={facultyId} roles={roles} /> </ProtectedRoute>} />
