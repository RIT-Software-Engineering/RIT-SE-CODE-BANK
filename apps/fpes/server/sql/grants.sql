CREATE TABLE IF NOT EXISTSgrants (
...
(3, 'Smart Cities IoT', 'NSF', NULL, 110000, '2025-2028', 'Principal Investigator', 70000, 'Development', 'Drafting proposal and preparing collaborators'),
(7, 'Precision Agriculture with Drones', 'USDA', NULL, 95000, '2025-2029', 'Co-PI', 35000, 'Development', 'Significant progress made, data collection underway');