INSERT INTO archive (name, title, team_name, members, coach, poster_thumb, synopsis, inactive, featured)
VALUES 
    ('Name 1', 'Business Action Tracking', 'BAT Team', 'Shayde Nofziger, Chris Jones, Alex Parrill, Corban Mailloux, Adam McCarthy', 'Sam Malachowsky', 'BAT-Thumb.jpg',
    ...
    ('Name 2', 'RaceChipper 2.0', 'The Chipper Racers', 'Caitlin Li, Colton Dennis, Matthew Crawford, Sam Shiffman', 'Bruce Herring', 'ChipperRacers-Thumb.jpg',
    ...
    ('Name 3', 'Wegmans Organic Farm', 'Team Woof', 'Luke Harrold, Colton Venditto, Courtney McGorrill, Derick Yung', 'Kenn Martinez', 'WOOF-Thumb.jpg',
