...
export default function ActionPanel(props) {
  ...
  let formFieldArray = [
    ...
    // TODO: make dropdown to select projects instead of inputting project id
    // {
    //   type: "dropdown",
    //   label: "Project",
    //   placeHolder: "Project",
    //   name: "project",
    //   options: createProjectDropdownOptions(props.projectData),
    //   nullValue: PROJECT_DROPDOWN_NULL_VALUE,
    //   loading: props.projectData.loading,
    // },
    {
      type: "input",
      label: "Project",
