            ...
            {selectedApp && (
              <>
                ...
                <DialogContent dividers>
                  ...
                  <Typography margin={2}>
                    <strong>
                      When did you start searching for this co-op?
                    </strong>{" "}
                    <br />
                  ...
                  <Typography margin={2}>
                    <strong>
                      What methods/platforms have you used in order to try and
                      get this co-op? Name as many as you can recall that you
                      would be able to provide evidence if needed (e.g.
                  ...
                  <Typography margin={2}>
                    <strong>
                      ...
                      employer and your last date of contact for each. If
                      possible provide Company/position and location. (e.g. 1.-
                      Microsoft/Intern Seattle, WA April 2nd 2025, 2.-
                  ...
                  <Typography margin={2}>
                    <strong>
                      ...
                      recall that you would be able to provide evidence if
                      needed. Companies/Employers and approximate date. (e.g.
                      1.- Google, January 16th 2025, 2.- Meta, February 18th
                      2025)
                    </strong>{" "}
                    <br />
                  ...
                  <Typography margin={2}>
                    <strong>
                      ...
                      However, IF an approved unpaid opportunity became
                      available, would you be interested in pursuing it?
                    </strong>{" "}
                    <br />
                  ...
                  <Typography margin={2}>
                    <strong>
                      If an option were to become available, would you be able
                      to participate in-person at RIT or are your circumstances
                      such that you would be unable to for the duration of the
                      co-op?
                    </strong>{" "}
                    <br />
                  ...
                  <Typography margin={2}>
                    <strong>
                      ...
                      stating your capabilities (e.g. laptop/desktop/webcam/mic
