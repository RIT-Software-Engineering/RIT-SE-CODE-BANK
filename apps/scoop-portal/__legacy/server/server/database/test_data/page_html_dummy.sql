...
('homePagePanel', '<div class="row">
                                   <h2>Welcome to SCOOP Portal</h2>
                               </div>
                               <div class="row">
                                   <p class="overviewText">
                                       The Software Engineering Unpaid Co-Op program is a small-scale, exclusive program for students in need when they are unable to otherwise fulfill their co-op program requirements. Students work together on rigorous projects meant to challenge them on a similar level to real-world co-op projects. Staff and other third-party members will propose projects for small teams of students to work on.
                                   </p>
                                   <p class="overviewText">
                                       Over the course of one term, each team works with a project coach and coordinator, applying the software engineering skills that the students learned in class and in co-op. They carry the project from inception through an entire software development lifecycle. The end result is a functional software deliverable.
                                   </p>
                               </div>'),
('sponsor', '<div class="row">
                             <h2 class="ui header">Propose a Co-Op Project</h2>
                         </div>
                         <div class="row">
                             <p>
                         ...
                         <div class="row">
                             <h2 class="ui header">Proposal F.A.Q.</h2>
                         </div>
                         <div class="row">
                             <p>
                                 Is your organization interested in proposing an unpaid Co-Op Project? Browse the FAQs below for more
                                information.
                             </p>
                             <br />
             ...
             $(".ui.accordion").accordion();
               ...
               <div class="content">
                 <ul>
                                     <li>
                                         Teams generally are divided into groups of 3-5 students. Projects are expected to last roughly 1 semester (~15 weeks). During this time, students are expected to contribute to the project like they would a 40-hour workweek.
                                     </li>
                                     <li>
               ...
               <div class="content">
                 <ul>
                                     <li>The project sponsor works with a team of students and a faculty coach.</li>
                                     <li>
