...
export const config = {
  url: {
    ...
    API_GET_PROJECTS_BY_SEMESTER: `${BASE_API_URL}/db/getProjectsBySemester`,
    ...
    API_POST_COPY_ACTION_SET: `${BASE_API_URL}/db/copyActionSet`,
    ...
    API_POST_CREATE_PROJECT: `${BASE_API_URL}/db/createProject`,
    ...
    //*** NEW API CALLS FOR SCOOP PORTAL  ***//
    API_GET_PARENT_ACTIONS: `${BASE_API_URL}/db/getParentActions`,
    API_GET_TIMELINE_SUB_ACTIONS: `${BASE_API_URL}/db/getTimelineSubActions`,
    API_GET_ACTIONS_BY_PROJECT: `${BASE_API_URL}/db/getActionsByProject`,
    API_DELETE_ACTION: `${BASE_API_URL}/db/removeAction`,
  },
};
...
export const ACTION_TARGETS = {
  ...
  team: "team",
  coach: "coach",                     // coach action visible to the team
  coach_hidden: 'coach_hidden', // coach action visible to only coach and admin
  admin: "admin",
  private: "private",
